...
class Deque:
    ...
    def __eq__(self, target):
        ...
        if self._count != target._count:
            ...
            while self_node is not None and self_node._value == target_node._value:
                self_node = self_node._next
                target_node = target_node._next
        equals = self_node is None
        return equals
    ...
    def peek_front(self):
        ...
        return deepcopy(self._front_value)
