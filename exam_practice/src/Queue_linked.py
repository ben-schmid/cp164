...
class Queue:
    ...
    def remove(self):
        ...
        # grab value frome front
        value = self._front._value
        # set new front
        self._front = self._front._next
        self._count -= 1

        # If everything from queue is none, set front and rear to None
        if self._front is None:
            self._rear = None
    ...
    def _move_front_to_rear(self, source):
        ...
        # Clean up queue, set rear to none if front is none
    ...
    def combine(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        while source1._front and source2._front is not None:
