...
class Queue:
    ...
    def __eq__(self, target):
        ...
        """
        equals = True
        if self.__len__() is not target.__len__():
            equals = False

        i = 0
        while i < self.__len__() and equals is True:
            if self._values[i] is not target._values[i]:
                equals = False
            i += 1
        return equals
        ...
        while len(source1) > 0 and len(source2) > 0:
            if i % 2 != 0:
                if len(source1._values) > 0:
                    self._values.insert(source1._values.remove())
                else:
                    self._values.insert(source2._values.remove())
            else:
